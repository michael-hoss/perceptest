...
def get_test_case_paths() -> ArterySimLog:
    ...
    paths_v6_sim15_01 = ArterySimLog(
...
@pytest.fixture
def test_case_paths() -> ArterySimLog:
    return get_test_case_paths()


@pytest.fixture
def artery_data(test_case_paths: ArterySimLog) -> ArteryData:
