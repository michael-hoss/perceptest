...
from inputs.artery.conftest import get_test_case_dump
...
def manual_data_analysis() -> None:
    ...
    artery_log_raw: ArterySimLog = load_from_artery_logs(sim_log_dump=get_test_case_dump())
    ...
    artery_log_timestamps_tidy: ArterySimLog = pull_artery_sim_log(artery_sim_log_dump=get_test_case_dump())
